...
def paginacontato():
    ...
    #criar borda para o container
    container.markdown("<style>div[data-baseweb='card'] {border: 2px solid red;}</style>", unsafe_allow_html=True)
    #mudar a cor do container para verde
    container.markdown("<style>div[data-baseweb='card'] {background-color: green;}</style>", unsafe_allow_html=True)
