...
__all__ = [
    'SVP_7', 'SECFIgnoreWidth',
    'DISPID_SRGCmdLoadFromProprietaryGrammar',
    'SPEI_START_INPUT_STREAM', '__MIDL_IWinTypes_0009', 'SPWORDTYPE',
    'SPSNoun', 'DISPID_SPAStartElementInResult',
    'DISPID_SWFEBlockAlign', 'SPWF_INPUT', 'SRERequestUI',
    'SPEI_PROPERTY_NUM_CHANGE', 'SpSharedRecognizer',
    'eLEXTYPE_RESERVED8', 'SpeechVisemeFeature', 'SVSFlagsAsync',
    'DISPID_SRIsUISupported', 'SREAdaptation',
    'SpeechVoiceSkipTypeSentence', 'ISpPhraseAlt',
    'DISPID_SpeechFileStream', '_ISpeechRecoContextEvents',
    'SpeechTokenKeyUI', 'SPINTERFERENCE_NOISE', 'SSFMCreateForWrite',
    'SVSFUnusedFlags', 'DISPID_SpeechLexicon', 'SVP_14', 'SVP_15',
    'DISPIDSPRG', 'ISpeechPhraseReplacements', 'DISPID_SpeechVoice',
    'DISPID_SRCEFalseRecognition', 'SVEVoiceChange',
    'ISpeechResourceLoader', 'SAFT44kHz8BitMono', 'SBOPause',
    'DISPID_SWFEExtraData', 'SPEI_RESERVED5', 'SpMMAudioIn',
    'STCRemoteServer', 'DISPID_SRCSetAdaptationData',
    'SAFT11kHz8BitStereo', 'SRADefaultToActive', 'SPAUDIOSTATUS',
    'DISPID_SRGState', 'SRSInactiveWithPurge', 'DISPIDSPTSI',
    'DISPID_SRCRetainedAudioFormat', 'SPWT_LEXICAL',
    'DISPID_SPIProperties', 'ISpRecoResult',
    'SWPUnknownWordUnpronounceable', 'SpVoice',
    'SAFTCCITT_ALaw_11kHzMono', 'DISPID_SGRSTWeight', 'WAVEFORMATEX',
    'SPWP_UNKNOWN_WORD_PRONOUNCEABLE', 'SPINTERFERENCE',
    'eLEXTYPE_RESERVED9', 'DISPID_SRGDictationUnload', 'SVSFNLPMask',
    'SITooSlow', 'SREStreamStart', 'DISPID_SVSLastStreamNumberQueued',
    'SAFTCCITT_ALaw_8kHzMono', 'SREStreamEnd',
    'Speech_Max_Word_Length', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPEActualConfidence', 'IInternetSecurityMgrSite',
    'DISPID_SPAsCount', 'SP_VISEME_8', 'SPSHORTCUTTYPE',
    'SDKLCurrentConfig', 'SP_VISEME_18', 'eLEXTYPE_RESERVED10',
    'DISPID_SpeechRecognizerStatus', 'SPSERIALIZEDPHRASE',
    'SpeechLoadOption', 'SPAS_RUN', 'DISPID_SRState',
    'DISPID_SRRTimes', 'SVPNormal', 'DISPID_SVSInputWordLength',
    'DISPID_SpeechLexiconPronunciation', 'DISPID_SVPause', 'SVPOver',
    'SPSHT_NotOverriden', 'SPAR_Low',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SRCEPhraseStart',
    'DISPID_SVSLastBookmarkId', 'SPLO_DYNAMIC', 'SPBO_NONE',
    'DISPID_SRSetPropertyString', 'DISPID_SPEPronunciation',
    'SLODynamic', 'DISPID_SRRTOffsetFromStart', 'DISPID_SPIGrammarId',
    'SPBO_AHEAD', 'SGDSActiveWithAutoPause',
    'DISPID_SLRemovePronunciationByPhoneIds',
    'DISPID_SVAlertBoundary', 'DISPID_SPRs_NewEnum', 'SpFileStream',
    'SAFTGSM610_22kHzMono', 'SAFTTrueSpeech_8kHz1BitMono',
    'SVSFParseSsml', 'SPPS_Verb', 'SAFTADPCM_11kHzMono',
    'SAFTCCITT_ALaw_11kHzStereo', 'SINoSignal', 'SPRECOGNIZERSTATUS',
    'SDTAll', 'SPVPRI_NORMAL', 'SFTInput', 'DISPID_SDKSetBinaryValue',
    'DISPID_SRCESoundStart', 'DISPID_SGRInitialState',
    'DISPID_SPEAudioSizeBytes', 'DISPID_SLPSymbolic', 'SVSFVoiceMask',
    'SpeechGrammarState', 'eLEXTYPE_PRIVATE9', 'SP_VISEME_1',
    'SAFT44kHz16BitMono', 'DISPID_SDKCreateKey', 'DISPID_SRStatus',
    'ISpGrammarBuilder', 'SPSHT_OTHER', 'SpCompressedLexicon',
    'SPRST_ACTIVE', 'SpeechVoiceEvents', 'SpObjectToken',
    'DISPID_SpeechPhraseProperty', 'SPAUDIOSTATE',
    'ISpeechMemoryStream', 'SECFIgnoreCase', 'DISPID_SGRSTNextState',
    'SRSEDone', 'SPEI_SENTENCE_BOUNDARY', 'ISpeechPhraseRule',
    'SPEI_TTS_PRIVATE', 'SDA_No_Trailing_Space',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SREPhraseStart',
    'ISpRecognizer', 'DISPID_SABIMinNotification',
    'SpeechSpecialTransitionType', 'DISPID_SRGCmdLoadFromFile',
    'SITooLoud', 'SVP_1', 'SpeechAddRemoveWord',
    'DISPID_SOTIsUISupported', 'SAFT16kHz16BitStereo',
    'DISPID_SVGetAudioInputs', 'IInternetSecurityManager',
    'SAFTCCITT_ALaw_22kHzStereo', '_ISpeechVoiceEvents',
    'SVEEndInputStream', 'eLEXTYPE_PRIVATE18',
    'DISPID_SpeechAudioStatus', 'ISpeechGrammarRuleStateTransition',
    'SpeechCategoryPhoneConverters', 'DISPID_SVSpeakCompleteEvent',
    'SAFTADPCM_22kHzStereo', 'DISPID_SGRsAdd', 'DISPID_SGRName',
    'DISPID_SRSetPropertyNumber', 'DISPID_SRGCommit',
    'DISPID_SDKEnumKeys', 'SECNormalConfidence', 'eLEXTYPE_USER',
    'DISPID_SWFESamplesPerSec', 'DISPID_SLPLangId', 'DISPID_SLWWord',
    'DISPID_SPERetainedSizeBytes', 'SPCATEGORYTYPE',
    'eLEXTYPE_VENDORLEXICON', 'DISPID_SGRSAddSpecialTransition',
    'DISPID_SpeechRecoResult', 'DISPID_SRProfile',
    'DISPID_SpeechBaseStream', 'DISPID_SDKSetStringValue', 'SBONone',
    'DISPID_SpeechLexiconWords', 'DISPID_SGRsCommitAndSave',
    'SPPS_RESERVED2', 'DISPID_SRDisplayUI', 'SITooQuiet',
    'SRAInterpreter', 'eLEXTYPE_PRIVATE15',
    'SpeechAudioFormatGUIDWave', 'SVEPhoneme',
    'DISPID_SVIsUISupported', 'DISPID_SRCERecognitionForOtherContext',
    'DISPID_SPIEngineId', 'ISpeechObjectToken', 'DISPID_SVRate',
    'SAFTCCITT_uLaw_22kHzMono', 'ISpeechXMLRecoResult',
    'SECHighConfidence', 'SVEBookmark', 'ISpeechPhraseInfo',
    'ISpeechPhraseReplacement', 'DISPID_SPCPhoneToId',
    'SPEVENTSOURCEINFO', 'SAFTCCITT_uLaw_8kHzStereo',
    'SAFT8kHz16BitStereo', 'DISPID_SpeechObjectTokenCategory',
    'SPDKL_CurrentUser', 'DISPID_SRGDictationLoad',
    'SAFT44kHz8BitStereo', 'SpeechBookmarkOptions',
    'DISPID_SRCRecognizer', 'DISPID_SPIEnginePrivateData',
    'SPSMF_SAPI_PROPERTIES', 'DISPID_SPRuleEngineConfidence',
    'SAFTDefault', 'DISPID_SPPConfidence', 'SASPause',
    'DISPID_SCSBaseStream', 'SWPUnknownWordPronounceable',
    'SpTextSelectionInformation', 'ISpStreamFormatConverter',
    'SPDKL_CurrentConfig', 'DISPID_SOTCategory',
    'SpeechCategoryAppLexicons', 'DISPID_SGRsCommit',
    'DISPID_SVAudioOutputStream', 'DISPID_SRGCmdLoadFromMemory',
    'DISPID_SPPsCount', 'DISPID_SAEventHandle',
    'SpeechPropertyLowConfidenceThreshold', 'DISPID_SVEPhoneme',
    'STSF_LocalAppData', 'DISPID_SPIAudioSizeTime',
    'SPINTERFERENCE_TOOLOUD', 'DISPID_SRRGetXMLResult', 'SVP_20',
    'SPEI_START_SR_STREAM', 'ISpMMSysAudio',
    'ISpeechLexiconPronunciations', 'DISPID_SAFGuid',
    'SREInterference', 'SVP_18', 'DISPID_SWFEFormatTag',
    'SECFIgnoreKanaType', 'DISPID_SGRSRule',
    'SAFTCCITT_uLaw_8kHzMono', 'SPGRAMMARSTATE', 'DISPID_SPCLangId',
    'SpLexicon', 'DISPID_SpeechXMLRecoResult', 'SRTReSent',
    'SPRST_INACTIVE', 'DISPID_SRGSetTextSelection',
    'SPTEXTSELECTIONINFO', 'DISPID_SPRDisplayAttributes',
    'SPSHT_EMAIL', 'DISPID_SDKOpenKey', 'eLEXTYPE_PRIVATE5',
    'DISPID_SVSCurrentStreamNumber', 'SpeechWordPronounceable',
    'SPWAVEFORMATTYPE', 'SpeechCategoryVoices',
    'DISPID_SVSyncronousSpeakTimeout', 'SPRECOCONTEXTSTATUS',
    'DISPID_SBSFormat', 'DISPID_SRSClsidEngine', 'DISPID_SLPsCount',
    'SPEI_VOICE_CHANGE', 'SPRS_INACTIVE', 'DISPID_SLWLangId',
    'eLEXTYPE_PRIVATE20', 'ISpProperties', 'ISpPhoneConverter',
    'SpeechRecoContextState',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'SSSPTRelativeToStart', 'SpeechTokenContext',
    'SpeechAudioProperties', 'DISPID_SRRAlternates',
    'DISPID_SPISaveToMemory', 'SPINTERFERENCE_NONE', 'SVEAllEvents',
    'DISPID_SRSCurrentStreamNumber', 'SRTExtendableParse',
    'DISPID_SGRSTsItem', 'SPCONTEXTSTATE',
    'DISPID_SOTCEnumerateTokens', 'DISPID_SOTSetId', 'SGDSActive',
    'SPEI_RECO_STATE_CHANGE', 'SWPKnownWordPronounceable',
    'SpeechGrammarTagDictation', 'SPLO_STATIC', 'SP_VISEME_14',
    'DISPID_SPRuleFirstElement', 'SASClosed',
    'DISPID_SDKGetStringValue', 'SPWORDPRONOUNCEABLE',
    'ISpEventSource', 'SpeechAudioFormatGUIDText', 'DISPID_SOTCId',
    'SpeechGrammarWordType', 'DISPID_SRGetPropertyNumber',
    'SDTAlternates', 'SPEI_MIN_SR', 'SPWP_KNOWN_WORD_PRONOUNCEABLE',
    'DISPID_SRCState', 'SAFTCCITT_uLaw_44kHzStereo',
    'tagSPPROPERTYINFO', 'ISpeechPhraseInfoBuilder',
    'ISpeechFileStream', 'DISPID_SAFGetWaveFormatEx',
    'ISpRecoContext', 'DISPID_SRSAudioStatus',
    'DISPID_SpeechPhraseReplacement', 'SpNotifyTranslator',
    'SGLexical', 'SPEI_RECOGNITION', 'DISPID_SGRSTs_NewEnum',
    'DISPID_SpeechRecoResultTimes', 'SpeechVoiceSpeakFlags',
    'DISPID_SASCurrentDevicePosition', 'DISPID_SVSPhonemeId',
    'DISPID_SVESentenceBoundary', 'DISPID_SABIEventBias',
    'SPRECOSTATE', 'SVEWordBoundary', 'SPRS_ACTIVE', 'SVSFIsNotXML',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet', 'SPPHRASEPROPERTY',
    'SPPS_Modifier', 'SAFTNonStandardFormat', 'DISPID_SPPValue',
    'SAFTADPCM_8kHzStereo', 'ISpSerializeState',
    'DISPID_SASCurrentSeekPosition', 'SGSEnabled',
    'eLEXTYPE_PRIVATE16', 'SGRSTTRule', 'SREFalseRecognition',
    'DISPID_SVVoice', 'SPEI_END_INPUT_STREAM', 'DISPID_SRAudioInput',
    'DISPID_SRCVoicePurgeEvent', 'DISPID_SGRSTPropertyValue',
    'DISPID_SRCPause', 'DISPID_SPIGetDisplayAttributes',
    'SPGS_DISABLED', 'DISPID_SGRAddResource',
    'ISpPhoneticAlphabetConverter', 'SVSFIsXML', 'SAFT11kHz8BitMono',
    'eWORDTYPE_ADDED', 'DISPID_SpeechGrammarRuleStateTransition',
    'SPRULESTATE', 'SpeechRecognizerState', 'DISPID_SRRTStreamTime',
    'eLEXTYPE_MORPHOLOGY', 'eLEXTYPE_RESERVED6', 'SSFMCreate',
    'SLTUser', 'DISPID_SVEViseme', 'DISPID_SRCERecognizerStateChange',
    'DISPID_SLWsItem', 'DISPID_SRGRules', 'SpeechLexiconType',
    'SLOStatic', 'DISPID_SRCCreateGrammar', 'SPBINARYGRAMMAR',
    'ISpeechRecoResult', 'SVP_10', 'DISPID_SPPs_NewEnum',
    'SRATopLevel', 'ISpeechPhraseAlternate',
    'SpeechPropertyResourceUsage', 'SpPhoneticAlphabetConverter',
    'DISPID_SPAsItem', 'DISPID_SOTDisplayUI', 'ISpeechGrammarRule',
    'SDTAudio', 'ISpeechGrammarRuleState', 'DISPID_SRGId',
    'DISPID_SRGDictationSetState', 'DISPID_SRGetRecognizers',
    'ISpeechRecoResultTimes', 'SAFTGSM610_8kHzMono',
    'DISPID_SPPChildren', 'DISPID_SVEAudioLevel',
    'DISPID_SGRSAddRuleTransition', 'DISPID_SBSWrite',
    'SECLowConfidence', 'SAFTADPCM_11kHzStereo', 'SRSInactive',
    'eLEXTYPE_APP', 'DISPID_SpeechRecoContext',
    'SpeechStreamSeekPositionType', 'DISPID_SLGetPronunciations',
    'SPSMF_SRGS_SAPIPROPERTIES', 'SPBO_TIME_UNITS',
    'SAFT16kHz8BitMono', 'DISPID_SGRSAddWordTransition',
    'SGRSTTWildcard', 'SVP_13', 'SPSLMA',
    'DISPID_SRSCurrentStreamPosition', 'SPEVENTENUM',
    'SAFT24kHz16BitMono', 'DISPID_SPPName', 'SPSHORTCUTPAIR',
    'SpeechTokenKeyFiles', 'DISPID_SABufferInfo',
    'SPEI_TTS_AUDIO_LEVEL', 'SPDKL_DefaultLocation',
    'DISPID_SRCRetainedAudio', 'Speech_StreamPos_RealTime',
    'SAFTCCITT_uLaw_44kHzMono', 'ISpeechAudioFormat', 'SPEI_MIN_TTS',
    'SPPS_RESERVED4', 'DISPID_SOTCreateInstance',
    'ISpeechRecoContext', 'DISPID_SRRAudioFormat',
    'DISPID_SWFEChannels', 'SAFT22kHz8BitStereo', 'DISPID_SOTDataKey',
    'DISPID_SGRAddState', 'SpUnCompressedLexicon',
    'DISPID_SMSGetData', 'SPXRO_SML', 'DISPID_SpeechRecoResult2',
    'ISpeechVoiceStatus', 'SAFTCCITT_ALaw_44kHzStereo',
    'DISPID_SASetState', 'SpeechPropertyHighConfidenceThreshold',
    'SpObjectTokenCategory', 'DISPID_SRRTTickCount',
    'SPEI_SOUND_START', 'DISPID_SOTGetDescription',
    'SPWORDPRONUNCIATIONLIST', 'SGRSTTTextBuffer',
    'SAFTNoAssignedFormat', 'DISPID_SRCEAdaptation',
    'eLEXTYPE_PRIVATE4', 'SPCS_ENABLED', 'eLEXTYPE_PRIVATE11',
    'SAFTCCITT_uLaw_11kHzMono', 'SpMMAudioEnum', 'SPWORDLIST',
    'DISPID_SRRGetXMLErrorInfo', 'ISpeechLexicon',
    'DISPID_SRRSaveToMemory', 'ISpeechObjectTokens',
    'DISPID_SPAs_NewEnum', 'DISPID_SRRPhraseInfo', 'SRAONone',
    'DISPID_SPRsItem', 'ISpeechLexiconWords', 'DISPID_SPRText',
    'SPVPRI_OVER', 'STSF_FlagCreate', 'SAFTCCITT_ALaw_22kHzMono',
    'ISpDataKey', 'SPAO_RETAIN_AUDIO',
    'DISPID_SpeechPhraseReplacements', 'ISpResourceManager',
    'DISPID_SDKGetBinaryValue', 'DISPID_SPIRule',
    'DISPID_SVSRunningState', 'SpeechVoiceCategoryTTSRate',
    'Speech_Default_Weight', 'DISPID_SRSNumberOfActiveRules',
    'SDKLCurrentUser', 'DISPID_SRGCmdSetRuleIdState',
    'DISPID_SDKEnumValues', 'DISPID_SpeechPhraseRule', 'SPSVerb',
    'DISPID_SDKSetLongValue', 'DISPID_SLWPronunciations',
    'DISPID_SVEStreamEnd', 'DISPID_SGRSTText', 'ISpeechWaveFormatEx',
    'DISPID_SpeechAudioFormat', 'SP_VISEME_6', 'SVP_9',
    'DISPID_SVEBookmark', 'SPSFunction', 'SPCS_DISABLED',
    'SPWT_DISPLAY', 'SPPS_RESERVED1', 'SPAO_NONE', 'SPEI_SR_PRIVATE',
    'SpeechUserTraining', 'SAFT48kHz8BitStereo',
    'DISPID_SPCIdToPhone', 'ISpStream', 'SPPS_Function',
    'DISPID_SAFType', 'SPINTERFERENCE_TOOFAST',
    'DISPID_SRCEEnginePrivate', 'SSTTDictation',
    'SAFTADPCM_44kHzMono', 'SpeechCategoryAudioIn',
    'DISPID_SMSAMMHandle', 'SPEI_MAX_SR', 'DISPID_SPIElements',
    'DISPID_SRRRecoContext', 'SPEI_HYPOTHESIS',
    'SAFTCCITT_uLaw_11kHzStereo', 'SAFT16kHz16BitMono',
    'ISequentialStream', 'SPSHT_Unknown', 'DISPID_SPEDisplayText',
    'SAFT12kHz8BitStereo', 'SREBookmark', 'SPEI_WORD_BOUNDARY',
    'DISPID_SGRClear', 'SVP_8',
    'DISPID_SpeechGrammarRuleStateTransitions',
    'SpNullPhoneConverter', 'DISPID_SPRuleChildren', 'SPEI_RESERVED6',
    'SPBO_PAUSE', 'SP_VISEME_15', 'SPGS_EXCLUSIVE',
    'DISPID_SPACommit', 'ISpObjectWithToken', 'SPGS_ENABLED',
    'DISPID_SRCEInterference', 'ISpPhrase', 'SPSNotOverriden',
    'SpeechTokenShellFolder', 'SpeechVoicePriority',
    'DISPID_SOTMatchesAttributes', 'ISpeechAudioStatus',
    'DISPID_SPEsItem', 'DISPID_SRCEPropertyStringChange',
    'SpCustomStream', 'DISPID_SVSpeakStream', 'SAFT12kHz8BitMono',
    'DISPID_SPERequiredConfidence', 'ISpRecoGrammar',
    'DISPID_SPELexicalForm', 'DISPID_SPRuleNumberOfElements',
    'SDTRule', 'SPEI_SR_RETAINEDAUDIO', 'SAFT24kHz16BitStereo',
    'DISPID_SRRecognizer', 'DISPID_SVGetVoices', 'ISpStreamFormat',
    'DISPID_SpeechWaveFormatEx', 'SPSInterjection',
    'DISPID_SPPBRestorePhraseFromMemory',
    'DISPID_SPPNumberOfElements', 'SDA_Two_Trailing_Spaces', 'SVP_19',
    'SAFTExtendedAudioFormat', 'SpResourceManager', 'SPEVENT',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'SDA_Consume_Leading_Spaces', 'ISpeechDataKey',
    'eLEXTYPE_LETTERTOSOUND', 'SpShortcut', 'SPAR_Unknown', 'SVP_3',
    'SPEI_PROPERTY_STRING_CHANGE', 'SpeechRuleState', 'SASRun',
    'DISPID_SLPPartOfSpeech', 'DISPID_SPIAudioSizeBytes',
    'ISpeechCustomStream', 'SRTAutopause', 'SRTSMLTimeout',
    'DISPID_SpeechPhraseAlternate', 'SP_VISEME_9', 'SPAR_High',
    'DISPID_SVSInputSentencePosition', 'SRSActive',
    'SGPronounciation', 'ISpPhoneticAlphabetSelection',
    'DISPID_SWFEBitsPerSample', 'DISPID_SOTId',
    'SAFT12kHz16BitStereo', 'SAFTADPCM_22kHzMono', 'SP_VISEME_10',
    'eLEXTYPE_RESERVED7', 'SRAORetainAudio', 'SpeechAudioVolume',
    'DISPID_SOTsCount', 'SVSFParseMask', 'DISPID_SGRsItem',
    'SpeechRetainedAudioOptions', 'SAFT48kHz8BitMono',
    'DISPID_SVGetProfiles', 'SPRS_ACTIVE_WITH_AUTO_PAUSE',
    'SPXMLRESULTOPTIONS', 'DISPID_SPAPhraseInfo', 'SREAudioLevel',
    'ISpeechTextSelectionInformation', 'DISPID_SOTs_NewEnum',
    'SASStop', 'SPAUDIOOPTIONS', 'SFTSREngine',
    'DISPID_SADefaultFormat', 'DISPID_SDKGetlongValue',
    'ISpeechGrammarRuleStateTransitions', 'DISPID_SRGCmdSetRuleState',
    'SpeechTokenIdUserLexicon', 'SPCT_DICTATION', 'SDTProperty',
    'DISPID_SGRSTRule', 'SPPS_NotOverriden', 'SpWaveFormatEx',
    'eLEXTYPE_PRIVATE7', 'SPRST_INACTIVE_WITH_PURGE', 'SECFDefault',
    'SpeechFormatType', 'DISPID_SVGetAudioOutputs',
    'SpeechEngineProperties', 'SGSExclusive', 'DISPID_SLWs_NewEnum',
    'DISPID_SLAddPronunciationByPhoneIds', 'SAFTGSM610_44kHzMono',
    'ISpRecognizer3', 'SPINTERFERENCE_TOOSLOW',
    'SpeechGrammarRuleStateTransitionType', 'ISpNotifySource',
    'DISPID_SMSALineId', 'DISPID_SRCEBookmark', 'SPGRAMMARWORDTYPE',
    'DISPID_SVStatus', 'DISPID_SpeechLexiconWord',
    'SpPhraseInfoBuilder', 'SPFM_OPEN_READWRITE', 'SPFM_NUM_MODES',
    'SAFTCCITT_uLaw_22kHzStereo', 'ISpeechRecognizer',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'SDKLDefaultLocation', 'DISPID_SPRFirstElement',
    'SSSPTRelativeToCurrentPosition', 'eLEXTYPE_RESERVED4',
    'SPFM_CREATE_ALWAYS', 'SPPHRASEELEMENT', 'SP_VISEME_20',
    'eLEXTYPE_PRIVATE10', 'SAFTADPCM_44kHzStereo',
    'DISPID_SREmulateRecognition', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SAFSetWaveFormatEx', 'SPSUnknown',
    'DISPID_SPEAudioStreamOffset', 'SPSEMANTICFORMAT', 'SRAImport',
    'SPEI_RESERVED2', 'DISPID_SGRSTPropertyName', 'DISPID_SVEWord',
    'DISPID_SRCAudioInInterferenceStatus',
    'DISPID_SVSInputSentenceLength', 'ISpeechRecognizerStatus',
    'SPCT_SUB_COMMAND', 'SpStreamFormatConverter',
    'SpeechPropertyResponseSpeed', 'SAFT11kHz16BitMono',
    'SpeechVisemeType', 'SSTTTextBuffer', 'DISPID_SPPParent',
    'SPPHRASE', 'SAFT12kHz16BitMono', 'DISPID_SGRId',
    'DISPID_SRRSetTextFeedback', 'SVP_11', 'SVF_Emphasis',
    'DISPID_SPPEngineConfidence', 'DISPID_SLPPhoneIds',
    'DISPID_SRCERecognition', 'ISpRecoContext2',
    'DISPID_SpeechPhraseBuilder', 'DISPID_SPEDisplayAttributes',
    'ISpObjectToken', 'DISPID_SPRules_NewEnum', 'SP_VISEME_11',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'SPPS_SuppressWord',
    'IEnumSpObjectTokens', 'DISPID_SFSOpen', 'ISpXMLRecoResult',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SGDSInactive',
    'DISPID_SRCEHypothesis', 'SVEAudioLevel', 'SAFT22kHz16BitStereo',
    'eLEXTYPE_PRIVATE19', 'DISPID_SVEventInterests', 'SPFILEMODE',
    'tagSPTEXTSELECTIONINFO', 'ISpAudio', 'SVSFParseSapi',
    'ISpeechVoice', 'SPPHRASEREPLACEMENT', 'ISpeechLexiconWord',
    'DISPID_SPIStartTime', 'SPFM_CREATE', 'SP_VISEME_13', 'UINT_PTR',
    'DISPID_SPEs_NewEnum', 'SpeechCategoryRecognizers',
    'DISPID_SPEsCount', 'SPEI_VISEME', 'SP_VISEME_3',
    'DISPID_SRRAudio', 'SREHypothesis', 'SRSEIsSpeaking',
    'ISpShortcut', 'DISPID_SMSADeviceId',
    'DISPID_SpeechPhraseProperties', 'DISPID_SLAddPronunciation',
    'SpInProcRecoContext', 'eLEXTYPE_PRIVATE8', 'SPAUDIOBUFFERINFO',
    'DISPID_SRGetPropertyString', 'SREStateChange', 'SRERecognition',
    'SPPS_Interjection', 'SPSHORTCUTPAIRLIST',
    'DISPID_SPIAudioStreamPosition', 'SpeechMicTraining',
    'DISPID_SPEAudioSizeTime', 'eLEXTYPE_PRIVATE12',
    'ISpNotifyTranslator', 'SpeechAllElements', 'DISPID_SRCESoundEnd',
    'DISPID_SLWType', 'SVP_21', 'DISPID_SpeechObjectToken',
    'SpeechRegistryLocalMachineRoot', 'SpeechPartOfSpeech',
    'SPWORDPRONUNCIATION', 'SpeechTokenValueCLSID',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'SREAllEvents',
    'DISPID_SASFreeBufferSpace', 'SPEI_SR_BOOKMARK', 'SP_VISEME_7',
    'ISpeechPhoneConverter', 'SVP_5', 'SVEStartInputStream',
    'SpMemoryStream', 'ISpeechPhraseElements', 'ISpeechRecoGrammar',
    'DISPID_SVEEnginePrivate', 'DISPID_SGRsFindRule',
    'DISPID_SVEStreamStart', 'SP_VISEME_2', 'SRSActiveAlways',
    'SPEI_RESERVED3', 'SGSDisabled', 'DISPID_SRRTLength',
    'STCLocalServer', 'STCAll', 'SPEI_END_SR_STREAM', 'SGDisplay',
    'DISPID_SFSClose', 'STSF_AppData', 'DISPID_SGRSTPropertyId',
    'SPSModifier', 'SPPROPERTYINFO', 'ISpeechBaseStream',
    'SPADAPTATIONRELEVANCE', 'SRARoot', 'eLEXTYPE_PRIVATE2',
    'DISPID_SASNonBlockingIO', 'SPSEMANTICERRORINFO',
    'DISPID_SRRSpeakAudio', 'SpeechRecoEvents',
    'SPXRO_Alternates_SML', 'SDTPronunciation',
    'DISPID_SRCEStartStream', 'DISPID_SPPsItem',
    'DISPID_SRCEAudioLevel', 'SDKLLocalMachine', 'SAFTADPCM_8kHzMono',
    'SP_VISEME_19', 'SpeechDataKeyLocation', 'SVEViseme',
    'DISPID_SGRAttributes', 'ISpeechPhraseProperties', 'SPEI_PHONEME',
    'SVSFDefault', 'DISPID_SPRuleName',
    'SpeechDictationTopicSpelling', 'eLEXTYPE_PRIVATE1', 'SRADynamic',
    'ISpeechPhraseRules', 'DISPID_SVSLastBookmark',
    'SAFT44kHz16BitStereo', 'SAFT48kHz16BitStereo', 'SPPS_Unknown',
    'SPAS_STOP', 'DISPID_SGRsDynamic', 'Speech_StreamPos_Asap',
    'DISPID_SDKDeleteValue', 'DISPID_SLPs_NewEnum',
    'eLEXTYPE_PRIVATE13', 'ISpeechMMSysAudio', 'SSFMOpenForRead',
    'DISPID_SGRSTsCount', 'DISPID_SABIBufferSize',
    'eLEXTYPE_PRIVATE17', 'DISPID_SVResume', 'SpeechRecognitionType',
    'SPSTREAMFORMATTYPE', 'DISPID_SRCRequestedUIType',
    'DISPID_SPANumberOfElementsInResult', 'DISPID_SOTsItem',
    'SPPS_Noun', 'DISPID_SAVolume', 'SpeechCategoryRecoProfiles',
    'SAFT22kHz16BitMono', 'SPEI_RECO_OTHER_CONTEXT',
    'ISpeechPhraseElement', 'SP_VISEME_0',
    'DISPID_SRGSetWordSequenceData', 'SVP_6',
    'DISPID_SRAudioInputStream', 'SpeechAudioState', 'SITooFast',
    '_SPAUDIOSTATE', 'SP_VISEME_16', 'SPDATAKEYLOCATION',
    'DISPID_SVSpeak', 'SPEI_TTS_BOOKMARK', 'SDTReplacement',
    'DISPID_SASState', 'SSTTWildcard', 'ISpEventSink',
    'SGLexicalNoSpecialChars', 'ISpeechPhraseAlternates',
    'ISpNotifySink', 'SAFT16kHz8BitStereo', 'SVP_17',
    'SpeechRuleAttributes', 'SGRSTTDictation', 'DISPID_SVSVisemeId',
    'SRCS_Disabled', 'SPRST_NUM_STATES', 'DISPID_SVPriority',
    'DISPID_SpeechPhraseRules', 'SPBOOKMARKOPTIONS',
    'DISPID_SpeechCustomStream', 'SPINTERFERENCE_NOSIGNAL',
    'SRERecoOtherContext', 'SRCS_Enabled', 'eWORDTYPE_DELETED',
    'SINone', 'ISpeechAudioBufferInfo', 'SAFT8kHz16BitMono',
    'DISPID_SRRDiscardResultInfo', 'SRTStandard', 'SPVPRI_ALERT',
    'DISPID_SRGetFormat', 'DISPID_SRCCreateResultFromMemory',
    '__MIDL___MIDL_itf_sapi_0000_0020_0001',
    'DISPIDSPTSI_SelectionOffset', 'DISPID_SOTCGetDataKey',
    'SP_VISEME_4', 'DISPID_SRGCmdLoadFromResource',
    'DISPID_SPIGetText', 'DISPID_SGRSTransitions',
    'DISPID_SPEEngineConfidence', 'SVP_4', 'SRESoundStart',
    'ISpRecoCategory', 'SPLEXICONTYPE', 'SREPropertyStringChange',
    'SAFT48kHz16BitMono', 'DISPID_SOTRemoveStorageFileName',
    'SPPS_RESERVED3', 'SPRS_ACTIVE_USER_DELIMITED',
    'DISPID_SGRsCount', 'DISPID_SPRulesCount', 'SLTApp', 'SPPS_LMA',
    'SPWORD', 'DISPID_SOTGetStorageFileName', 'DISPID_SpeechDataKey',
    'DISPID_SOTCDefault', 'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C',
    'DISPID_SLGetWords', 'SAFT24kHz8BitStereo',
    'DISPID_SRCEEndStream', 'SVF_Stressed', 'SPWT_PRONUNCIATION',
    'SRTEmulated', 'DISPID_SGRSTType', 'LONG_PTR', 'SWTAdded',
    'SPCT_COMMAND', 'SP_VISEME_21', 'DISPID_SPRuleConfidence',
    'SpeechAudioFormatType', 'DISPID_SLGetGenerationChange',
    'ISpeechGrammarRules', 'SpeechEmulationCompareFlags',
    'DISPID_SVDisplayUI', 'DISPID_SLWsCount', 'SVESentenceBoundary',
    'SpStream', 'SSSPTRelativeToEnd', 'DISPID_SpeechGrammarRules',
    'SVF_None', 'DISPID_SpeechRecognizer',
    ...
    'eLEXTYPE_PRIVATE14', 'DISPID_SVSLastResult',
    'DISPID_SpeechVoiceEvent', 'ISpVoice',
    'SpeechGrammarTagUnlimitedDictation', 'SPWF_SRENGINE',
    'DISPID_SpeechMemoryStream', 'SpeechRegistryUserRoot',
    'SPSSuppressWord', 'SGDSActiveUserDelimited',
    'DISPID_SGRs_NewEnum', 'DISPID_SRCEPropertyNumberChange',
    'DISPID_SpeechRecoContextEvents', 'SpeechDiscardType',
    'SpeechInterference', 'DISPID_SpeechObjectTokens',
    'ISpeechRecoResult2', 'SVP_16', 'DISPID_SpeechLexiconProns',
    'SP_VISEME_5', 'SRESoundEnd', 'SpeechWordType',
    'SpPhoneConverter', 'DISPID_SpeechGrammarRuleState',
    'DISPID_SpeechGrammarRule', 'SPRECORESULTTIMES',
    'DISPID_SPRsCount', 'DISPID_SPPFirstElement', 'eLEXTYPE_PRIVATE6',
    'DISPID_SPRuleId', 'SREPrivate', 'SP_VISEME_12',
    'SECFEmulateResult', 'ISpeechRecoResultDispatch', 'SVEPrivate',
    'SDTDisplayText', 'SDA_One_Trailing_Space', 'DISPID_SRCResume',
    'DISPID_SPARecoResult', 'ISpeechLexiconPronunciation',
    'SVSFNLPSpeakPunc', 'DISPID_SpeechMMSysAudio',
    'ISpeechObjectTokenCategory', 'SPFM_OPEN_READONLY',
    'Speech_Max_Pron_Length', 'DISPID_SPILanguageId',
    'SpInprocRecognizer', 'SpAudioFormat', 'DISPID_SPIReplacements',
    'SPEI_REQUEST_UI', 'DISPID_SpeechPhraseElement',
    'DISPID_SpeechAudioBufferInfo',
    'SpeechPropertyComplexResponseSpeed', 'DISPID_SpeechPhraseInfo',
    'DISPID_SpeechPhoneConverter', 'DISPID_SVWaitUntilDone',
    'SPDKL_LocalMachine', 'STCInprocHandler', 'SPVPRIORITY',
    'SPEI_SOUND_END', 'DISPID_SDKDeleteKey', 'SREPropertyNumChange',
    'SPRULE', 'SAFT24kHz8BitMono', 'SAFT32kHz16BitStereo',
    'DISPID_SRIsShared', 'SpeechPropertyAdaptationOn',
    'DISPID_SLGenerationId', 'SPPS_Noncontent', 'SPEI_UNDEFINED',
    'SpeechCategoryAudioOut', 'SAFTText',
    'DISPID_SPRNumberOfElements', 'DISPID_SABufferNotifySize',
    'SWTDeleted', 'SVP_2', 'SpSharedRecoContext', 'SPEI_PHRASE_START',
    'SRAExport', 'SpeechDisplayAttributes', 'DISPID_SOTCSetId',
    'SPVISEMES', 'SPAS_PAUSE', 'SAFTCCITT_ALaw_8kHzStereo',
    'SAFTCCITT_ALaw_44kHzMono', 'SpeechGrammarTagWildcard',
    'SpeechRunState', 'SPSMF_UPS', 'SPRST_ACTIVE_ALWAYS',
    'SPLOADOPTIONS', 'DISPID_SpeechPhraseElements',
    'DISPID_SpeechPhraseAlternates', 'IEnumString', 'tagSTATSTG',
    'SAFT22kHz8BitMono', 'DISPID_SRCCmdMaxAlternates',
    'ISpeechPhraseProperty', 'SAFT32kHz8BitMono', 'ISpRecognizer2',
    'SAFT11kHz16BitStereo', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'DISPIDSPTSI_ActiveLength', 'SGRSTTEpsilon', 'SPAS_CLOSED',
    'ISpObjectTokenCategory', 'STSF_CommonAppData',
    'DISPID_SOTGetAttribute', 'DISPID_SVAudioOutput', 'SVP_12',
    'DISPID_SRGIsPronounceable', 'SpeechStreamFileMode',
    'STCInprocServer', 'SpMMAudioOut', 'DISPID_SPRulesItem',
    'DISPID_SMSSetData', 'SAFT8kHz8BitMono', 'SAFTGSM610_11kHzMono',
    'SVP_0', 'SVSFPersistXML', 'SPPARTOFSPEECH', 'SAFT8kHz8BitStereo',
    'SPEI_MAX_TTS', 'DISPID_SRCBookmark', 'SPCT_SUB_DICTATION',
    'SVSFPurgeBeforeSpeak', 'DISPID_SLPType',
    'DISPID_SPEAudioTimeOffset', 'DISPID_SRGRecoContext',
    'DISPIDSPTSI_ActiveOffset',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'IStream',
    'DISPID_SLPsItem', '_RemotableHandle', 'SECFNoSpecialChars',
    'DISPID_SLRemovePronunciation', 'DISPID_SRCVoice',
    'SPVOICESTATUS', 'SPCT_SLEEP', 'DISPID_SRSSupportedLanguages',
    'SPPHRASERULE', 'SDTLexicalForm', 'SPAR_Medium',
    'eLEXTYPE_USER_SHORTCUT', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SBSSeek', 'ISpeechAudio', 'DISPID_SBSRead',
    'SVSFIsFilename', 'SPSERIALIZEDRESULT', 'ISpLexicon',
    'DISPID_SOTRemove', 'SPEI_ADAPTATION', 'SGRSTTWord',
    'DISPID_SRCERequestUI', 'SAFT32kHz8BitStereo', 'SP_VISEME_17',
    'DISPID_SPRuleParent', 'SVPAlert', 'SPEI_FALSE_RECOGNITION',
    'DISPIDSPTSI_SelectionLength', 'SpeechEngineConfidence',
    'DISPID_SVSkip', 'DISPID_SRCEventInterests', 'SPEI_RESERVED1',
    'SpeechRecoProfileProperties', 'SAFT32kHz16BitMono',
    'DISPID_SpeechVoiceStatus',
    'SpeechPropertyNormalConfidenceThreshold', 'SINoise',
    'DISPID_SVVolume', 'SSFMOpenReadWrite', 'ISpRecoGrammar2',
    'SpeechTokenKeyAttributes', 'eLEXTYPE_PRIVATE3',
    'SPEI_INTERFERENCE', 'SPINTERFERENCE_LATENCY_WARNING',
    'SVSFParseAutodetect', 'DISPID_SPPId', 'DISPID_SpeechAudio',
