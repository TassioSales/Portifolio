...
pokemons = ["pikachu", "charmander", "bulbasaur", "squirtle", "ditto", "mew", "mewtwo",
            "snorlax", "eevee", "jigglypuff", "meowth", "psyduck", "pidgey", "rattata",
            "zubat", "caterpie", "weedle", "pidgeotto", "pidgeot", "raticate", "fearow",
            ...
            "bayleef", "meganium", "cyndaquil", "quilava", "typhlosion", "totodile", "croconaw",
            ...
            "delcatty", "sableye", "mawile", "aron", "lairon", "aggron", "meditite", "medicham",
            ...
            "deoxys-normal", "turtwig", "grotle", "torterra", "chimchar", "monferno", "infernape",
            ...
            "rampardos", "shieldon", "bastiodon", "burmy", "wormadam-plant", "mothim", "combee",
            ...
            "glameow", "purugly", "chingling", "stunky", "skuntank", "bronzor", "bronzong", "bonsly",
            ...
            "petilil", "lilligant", "basculin-red-striped", "sandile", "krokorok", "krookodile",
            "darumaka", "darmanitan-standard", "maractus", "dwebble", "crustle", "scraggy", "scrafty",
            ...
            "foongus", "amoonguss", "frillish", "jellicent", "alomomola", "joltik", "galvantula",
            ...
            "cubchoo", "beartic", "cryogonal", "shelmet", "accelgor", "stunfisk", "mienfoo", "mienshao",
            "druddigon", "golett", "golurk", "pawniard", "bisharp", "bouffalant", "rufflet", "braviary",
            "vullaby", "mandibuzz", "heatmor", "durant", "deino", "zweilous", "hydreigon", "larvesta",
            "volcarona", "cobalion", "terrakion", "virizion", "tornadus-incarnate", "thundurus-incarnate",
            "reshiram", "zekrom", "landorus-incarnate", "kyurem", "keldeo-ordinary", "meloetta-aria",
            ...
            "aegislash-shield", "spritzee", "aromatisse", "swirlix", "slurpuff", "inkay", "malamar",
            ...
            "carbink", "goomy", "sliggoo", "goodra", "klefki", "phantump", "trevenant", "pumpkaboo-average",
            "gourgeist-average", "bergmite", "avalugg", "noibat", "noivern", "xerneas", "yveltal",
            "zygarde", "diancie", "hoopa", "volcanion", "rowlet", "dartrix", "decidueye", "litten",
            "torracat", "incineroar", "popplio", "brionne", "primarina", "pikipek", "trumbeak", "toucannon",
            "yungoos", "gumshoos", "grubbin", "charjabug", "vikavolt", "crabrawler", "crabominable",
            "oricorio-baile", "cutiefly", "ribombee", "rockruff", "lycanroc-midday", "wishiwashi-solo",
            ...
            "mimikyu-disguised", "bruxish", "drampa", "dhelmise", "jangmo-o", "hakamo-o", "kommo-o",
            ...
            "zeraora", "meltan", "melmetal", "grookey", "thwackey", "rillaboom", "scorbunny", "raboot",
            "cinderace", "sobble", "drizzile", "inteleon", "skwovet", "greedent", "rookidee", "corvisquire",
            "corviknight", "blipbug", "dottler", "orbeetle", "nickit", "thievul", "gossifleur", "eldegoss",
            ...
            "arrokuda", "barraskewda", "toxel", "toxtricity-amped", "sizzlipede", "centiskorch",
            ...
            "zacian", "zamazenta", "eternatus", "kubfu", "urshifu-single-strike", "zarude", "regieleki",
            "regidrago", "glastrier", "spectrier", "calyrex", "venusaur-mega", "charizard-mega-x", "charizard-mega-y",
            "blastoise-mega", "alakazam-mega", "gengar-mega", "kangaskhan-mega", "pinsir-mega", "gyarados-mega",
            "aerodactyl-mega", "mewtwo-mega-x", "mewtwo-mega-y", "ampharos-mega", "scizor-mega", "heracross-mega",
            "houndoom-mega", "tyranitar-mega", "blaziken-mega", "gardevoir-mega", "mawile-mega", "aggron-mega",
            "medicham-mega", "manectric-mega", "banette-mega", "absol-mega", "garchomp-mega", "lucario-mega",
            "abomasnow-mega", "floette-eternal", "latias-mega", "latios-mega", "swampert-mega", "sceptile-mega",
            ...
            "groudon-primal", "rayquaza-mega", "pikachu-rock-star", "pikachu-belle", "pikachu-pop-star",
            "pikachu-phd", "pikachu-libre", "pikachu-cosplay", "hoopa-unbound", "camerupt-mega", "lopunny-mega",
            "salamence-mega", "beedrill-mega", "rattata-alola", "raticate-alola", "raticate-totem-alola",
            "raichu-alola", "sandshrew-alola", "sandslash-alola", "vulpix-alola", "ninetales-alola",
            "diglett-alola", "dugtrio-alola", "meowth-alola", "persian-alola", "geodude-alola", "graveler-alola",
            "golem-alola", "grimer-alola", "muk-alola", "exeggutor-alola", "marowak-alola", "greninja-ash",
            "zygarde-10", "zygarde-50", "zygarde-complete", "oricorio-pom-pom", "oricorio-pau", "oricorio-sensu",
            "lycanroc-midday", "wishiwashi-school", "minior-orange-meteor", "minior-yellow-meteor",
            "minior-green-meteor", "minior-blue-meteor", "minior-indigo-meteor", "minior-violet-meteor",
            "minior-indigo", "minior-green", "minior-blue", "minior-violet", "minior-orange", "minior-yellow",
            "mimikyu-busted", "mimikyu-totem-disguised", "mimikyu-totem-busted", "kommo-o-totem",
            "magearna-original", "pikachu-partner-cap", "lycanroc-dusk", "necrozma-dusk-mane", "necrozma-dawn-wings",
            "necrozma-ultra", "lurantis-totem", "salazzle-totem", "nihilego-rusted", "buzzwole-rusted",
            "pheromosa-rusted", "xurkitree-rusted", "celesteela-rusted", "kartana-rusted", "guzzlord-rusted",
            "poipole-rusted", "naganadel-rusted", "stakataka-rusted", "blacephalon-rusted", "pikachu-starter",
            "pikachu-hoenn-cap", "pikachu-sinnoh-cap", "pikachu-unova-cap", "pikachu-kalos-cap",
            "pikachu-alola-cap", "pikachu-partner-cap-orig", "pikachu-world-cap", "pikachu-kalos-cap-orig",
            "pikachu-unova-cap-orig", "pikachu-hoenn-cap-orig", "pikachu-sinnoh-cap-orig", "pikachu-alola-cap-orig",
            "pikachu-rock-star-cap", "pikachu-belle-cap", "pikachu-pop-star-cap", "pikachu-phd-cap",
            "pikachu-libre-cap", "pikachu-cosplay-cap", "pikachu-original-cap", "pikachu-hoenn-cap-orig",
            "pikachu-sinnoh-cap-orig", "pikachu-unova-cap-orig", "pikachu-kalos-cap-orig", "pikachu-alola-cap-orig",]

#contar pokemon da lista
print(len(pokemons))
#contar pokemon da lista sem repetição
print(len(set(pokemons)))
#contar quantidades de pokemos repetidos
print(len(pokemons) - len(set(pokemons)))
#criar uma lista sem repetição
pokemons_sem_repeticao = list(set(pokemons))
#cria uma lista em ordem alfabética
pokemons_ordem_alfabetica = sorted(pokemons_sem_repeticao)
