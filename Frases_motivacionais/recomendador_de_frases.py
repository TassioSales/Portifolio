...
df_piadas_ruins = pd.read_csv('https://raw.githubusercontent.com/TassioSales/Portifolio/main/Frases_motivacionais/piadas.csv', sep=';', encoding='utf-8')
...
#criar um dicionario com as perguntas e resposta das piadas
piadas_ruins =
